...
urlpatterns = [
    ...
    url('^logout', TemplateView.as_view(template_name='core/home.html'), name='logout'),
    url('^repositories', TemplateView.as_view(template_name='core/home.html'), name='repositories'),
