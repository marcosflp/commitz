...
@transaction.atomic
def add_and_monitor_new_repository(user, full_name, githubprofile_service, commit_service, content_service):
    """
    ...
    content_service.update_repository_contents(user, repository)
